...
<div id="outline">
    ...
    <a href="${pageContext.request.contextPath}/member/modifyForm.do">회원정보 수정하러 가기</a>
    <a href="${pageContext.request.contextPath}/member/logout.do">로그아웃</a>
    <%
        if ("20".equals(member.getUserType())) {
    %>
        <a href="${pageContext.request.contextPath}/admin/dashboard.do">관리자 페이지로 이동</a>
    <% } %>
    <%
        if ("10".equals(member.getUserType())) {
    %>
    <a href="${pageContext.request.contextPath}/member/signout.do">회원 탈퇴</a>
    <% } %>
    <%
    } else {
    %>
    ...
    <a href="${pageContext.request.contextPath}/member/loginForm.do">로그인 다시 시도</a>
    <%
        }
    %>
</div>
